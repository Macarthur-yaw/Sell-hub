...
export default function FooterCard(){
    return (
        <div className='relative mt-10 border-[1px] shadow-2xl mb-4 rounded-xl w-[90%] md:w-[85%] mx-auto'>
           <img src={adidasImage} alt='an adidas picture' className=' w-[96px] min-h-[200px] sm:h-[300px] mx-auto object-contain brightness-200'/>
        
            <span className='absolute left-1/2 transform w-full sm:w-auto -translate-x-1/2 bg-clip-text  z-20 top-0 p-2'>
         ...
         <div className=' w-fit mx-auto pt-2 md:pt-6'>
         ...
         <button className='tracking-tight rounded-2xl font-bold  shadow-md text-sm md:text-[14px] px-4 md:mt-6 p-2 bg-white text-black'>
           ...
           <div className='bg-black bg-gradient-to-r from-black to-black via-transparent  absolute top-0 rounded-xl bg-opacity-90 w-full z-10 h-full'>
